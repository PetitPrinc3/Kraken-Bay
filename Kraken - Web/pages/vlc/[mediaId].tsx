        ...
        <div>
            ...
            <div className="w-full h-full flex flex-col items-center py-10 md:py-20">
                ...
                <div className="flex md:hidden max-w-[95%] md:max-w-[90%] h-fit overflow-hidden bg-neutral-600 border-2 border-neutral-400 flex-col items-start gap-2 rounded-md px-4 py-2">
                    <p className="w-fit text-white text-light opacity-80">Path : </p>
                ...
                <div className="flex flex-col w-full items-start mt-10 px-4 md:px-16">
                    <div className=" w-full flex flex-row items-center justify-between">
                        ...
                        <a href="/Assets/Vlc/vlc.apk" className="flex md:hidden flex-row gap-2 items-center px-4 py-2 my-6 cursor-pointer rounded-md bg-orange-500 hover:opacity-80 transition duration-300">
                            <p className="text-white font-semibold">Download</p>
                        </a>
                    </div>
                    <div className="hidden lg:grid w-full grid-cols-5 gap-4 mt-5">
                        ...
                        <div className="w-full h-fit flex flex-col gap-4 py-2 px-4 rounded-md shadow-black shadow-lg hover:translate-x-1 hover:-translate-y-2 hover:scale-105 transition-all duration-500 cursor-pointer">
                            ...
                            <img className="w-full lg:w-auto lg:h-32" src="/Assets/Vlc/step3.png" alt="" />
                        ...
                        <div className="w-full h-fit flex flex-col gap-4 py-2 px-4 rounded-md shadow-black shadow-lg hover:translate-x-1 hover:-translate-y-2 hover:scale-105 transition-all duration-500 cursor-pointer">
                            ...
                            <img className="w-full lg:w-auto lg:h-32" src="/Assets/Vlc/step4.png" alt="" />
